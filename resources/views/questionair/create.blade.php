...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form  method="POST" class="form-horizontal" action="{{ url('questionair') }}">
                    ...
                    <div class="panel-body">
                        {{ csrf_field() }}
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                   <input id="name" value="{{old('name')}}" name="name" placeholder=" Name" class="form-control" required type="text">
                                    @if ($errors->has('name'))
                             ...
                             <div class="form-group  {{ $errors->has('duration') ? ' has-error' : '' }}">
                                 ...
                                 <div class="col-md-10">
                                     <div class="input-group">
                                        <input type="number" value="{{old('time')}}" id="time" name="time" required="required" class="form-control">
                                      
                                        <!-- insert this line -->
                                        <span class="input-group-addon" style="width:0px; padding-left:0px; padding-right:0px; border:none;"></span>
                                      
                                        <select id="" name="duration" class="form-control">
                                            <option {{old('duration') == 'Minutes' ? 'selected' : ''}} value="Minutes">Minutes</option>
                                            <option {{old('duration') == 'Hours' ? 'selected' : ''}} value="Hours">Hours</option>
                                        </select>
                                    </div>
                             ...
                             <div class="form-group {{ $errors->has('canResume') ? ' has-error' : '' }}">
                                 <div class="col-md-2">
                                 ...
                                 <div class="col-md-10">
                                     <div class="col-md-2">
                                          <div class="radio">
                                          <label><input type="radio" {{old('canResume') == 'Yes' ? 'checked' : '' }} checked value="Yes" name="canResume">Yes</label>
                                        </div>
                                     </div>
                                    <div class="col-md-2">
                                          <div class="radio">
                                          <label><input {{old('canResume') == 'No' ? 'checked' : ''}} type="radio" value="No" name="canResume">No</label>
                                        </div>
                                     </div>
                                    @if ($errors->has('duration'))
                                        <span class="help-block">
